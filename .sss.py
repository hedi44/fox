...
os.system("rm -rf .txt")
os.system("espeak -a 150 veryfast")
...
def menu():
    ...
    print("\033[32m.")
    os.system("clear")
    os.system("figlet Type ;espeak -a 150 type ;espeak -a 150 1 ;espeak -a 150 ;espeak -a 150 2 ;espeak -a 150 3")
...
def action():
    ...
    if bch == '':
        ...
        action()
    xxx = str(len(id))
    psb('\033[31m Hamw Line Akani .txt ka: ' + xxx)
    print '\033[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\033[0;1m'
